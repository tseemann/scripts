...
print STDERR "Writing: $prefix.coverages.txt\n";
open my $logfh, '>', "$prefix.coverages.txt";
...
sub setOptions {
  ...
  @Options = (
    ...
    {OPT=>"p|prefix=s",  VAR=>\$prefix, DEFAULT=>'coregenome', DESC=>"Prefix for output files: .fna .csv .txt"},
